...
// Added onLogout to the props here
function Navbar({ onAddProductClick, theme, toggleTheme, onLogout }) {
  return (
    <div className="flex flex-col md:flex-row justify-between p-4 
      ...
      {/* Kept your exact classes, just added onLogout at the end */}
